...
<section id="content">
	...
	<form id="enroll-container" name="memberEnrollFrm" action="${path}/admin/member/update" method="post">
		<table>
			<tr>
				<th>아이디</th>
				<td>
					<input type="text" name="id" id="id" value="${item.id}" required readonly>
				</td>
			</tr>		
			<tr>
				<th>이름</th>
			...
			<tr>
				<th>전화번호</th>
				<td>
					<input type="tel" name="phone" maxlength="11" value="${item.phone}" placeholder="(-없이)01012345678">
				</td>
			</tr>		
			<tr>
				<th>이메일</th>
	...
	$(function () {
		$("#deleteMember").click((e) => {
			if(confirm("정말로 탈퇴하시겠습니까?!")) {
				location.replace('${path}/admin/member/delete');
			}
		});
